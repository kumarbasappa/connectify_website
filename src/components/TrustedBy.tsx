...
export default function TrustedBy() {
  ...
  // Dynamically duplicate logo array in code for infinite seamless CSS keyframe marquee loop
  ...
  return (
    <section className="relative overflow-hidden border-y border-black/10 bg-background py-14 dark:border-white/10">
      ...
      <div className="relative mt-8 flex overflow-hidden">
        ...
        <div
          ref={containerRef}
          className="marquee-container flex w-max items-center gap-8 sm:gap-12"
        >
          <div className="flex shrink-0 animate-marquee items-center gap-8 sm:gap-12">
