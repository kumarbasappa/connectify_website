      ...
      <section className="bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gridBackground.png')] w-full bg-no-repeat bg-cover bg-center text-sm pb-44">
        <nav className="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-6 w-full">
          ...
          <div
            ...
            ref={menuRef}
            className={[
              'max-md:fixed max-md:top-0 max-md:left-0 max-md:transition-all max-md:duration-300 max-md:overflow-hidden max-md:h-full max-md:bg-white/90 max-md:backdrop-blur-md z-50',
          ...
          >
            ...
            <div className="relative group flex items-center gap-1 cursor-pointer">
              <span>Products</span>
              <ChevronDown className="w-4 h-4 text-[#050040]" />
              <div className="absolute bg-white font-normal flex flex-col gap-2 w-max rounded-lg p-4 top-36 left-0 opacity-0 -translate-y-full group-hover:top-44 group-hover:opacity-100 transition-all duration-300 shadow-sm pointer-events-none group-hover:pointer-events-auto">
        ...
        <div className="flex items-center gap-2 border border-slate-300 hover:border-slate-400/70 rounded-full w-max mx-auto px-4 py-2 mt-40 md:mt-32">
          ...
          <button className="flex items-center gap-1 font-medium">
            <span>Read more</span>
            <ArrowRight className="w-4 h-4 text-[#050040]" />
          </button>
        </div>
        ...
        <div className="mx-auto w-full flex items-center justify-center gap-3 mt-4">
          ...
          <button className="flex items-center gap-2 border border-slate-300 hover:bg-slate-200/30 rounded-full px-6 py-3">
            ...
            <ChevronDown className="w-3 h-3 text-[#050040]/40 -rotate-90" />
          </button>
        </div>
      </section>
    </>
