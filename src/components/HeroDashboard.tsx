...
export default function HeroDashboard() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-xl lg:max-w-none">
      ...
      <div className="relative rounded-2xl border border-slate-200 bg-white/95 p-5 shadow-2xl backdrop-blur-xl transition-all duration-500 hover:border-brand/40 dark:border-white/10 dark:bg-[#121927]/95 dark:shadow-indigo-950/40">
        ...
        <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-white/5 dark:bg-white/5">
          <div className="flex items-center justify-between font-mono text-xs text-slate-600 dark:text-slate-400">
            <span className="font-bold">REAL-TIME TRAFFIC LOAD</span>
        ...
        <div className="mt-4 space-y-2 font-mono text-[11px]">
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-slate-800 dark:border-white/5 dark:bg-white/5 dark:text-white/80">
            ...
            <span className="text-emerald-700 font-bold dark:text-emerald-400">120 Nodes Active</span>
          </div>
          ...
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-slate-800 dark:border-white/5 dark:bg-white/5 dark:text-white/80">
            ...
            <span className="text-brand font-bold dark:text-electric">0ms Lag</span>
          </div>
        </div>
      </div>
    </div>
