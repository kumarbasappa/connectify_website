  ...
  return (
    <>
      ...
      <motion.header
        ...
        className="fixed top-4 left-1/2 z-50 w-[92%] max-w-5xl -translate-x-1/2 overflow-hidden rounded-full border border-slate-200/80 bg-white/85 px-6 py-2.5 shadow-xl backdrop-blur-2xl transition-colors duration-300 dark:border-white/10 dark:bg-[#121927]/90 dark:shadow-indigo-950/30"
      >
          ...
          <div className="flex items-center gap-2 sm:gap-3 ml-auto md:ml-0">
            ...
            {mounted && (
              <button
                type="button"
                onClick={toggleTheme}
                className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-200/90 bg-white/80 text-slate-800 transition-colors hover:bg-slate-100 dark:border-white/15 dark:bg-white/10 dark:text-white/90 dark:hover:bg-white/20"
            ...
            <Link
              href="/contact"
              className="hidden sm:inline-flex items-center gap-2 rounded-full bg-slate-900 text-white hover:bg-slate-800 dark:bg-white dark:text-slate-950 dark:hover:bg-slate-100 px-5 py-2 text-xs font-semibold shadow-md transition-all duration-300"
            >
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-800 md:hidden dark:border-white/15 dark:bg-white/10 dark:text-white"
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-black/60 backdrop-blur-md md:hidden">
          <div className="fixed top-20 left-1/2 w-[90%] -translate-x-1/2 rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-white/10 dark:bg-[#121927]">
