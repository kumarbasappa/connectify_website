    ...
    <>
      ...
      <div className="px-6 py-16 lg:py-24 bg-background">
        <div className="mx-auto w-full max-w-7xl">
          {/* Dynamic Theme Category Filter Pills */}
          <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-black/10 bg-slate-100/80 p-3 shadow-xs backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-900/60">
            <Link
              href="/case-studies"
